...
import com.stylefeng.guns.rest.modular.alipay.demo.trade.config.Configs;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.ExtendParams;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.GoodsDetail;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.TradeStatus;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.builder.*;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.hb.*;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.result.AlipayF2FPayResult;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.result.AlipayF2FPrecreateResult;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.result.AlipayF2FQueryResult;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.model.result.AlipayF2FRefundResult;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.service.AlipayMonitorService;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.service.AlipayTradeService;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.service.impl.AlipayMonitorServiceImpl;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.service.impl.AlipayTradeServiceImpl;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.utils.Utils;
import com.stylefeng.guns.rest.modular.alipay.demo.trade.utils.ZxingUtils;
...
public class PayUtil {
   ...
   /* public static void main(String[] args) {
    ...
    // 测试当面付2.0查询订单
    public TradeStatus test_trade_query(String orderId) {
    ...
    // 测试当面付2.0生成支付二维码
    public TradeStatus test_trade_precreate(String orderId) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("D:\\tmp/qr-%s.png",
